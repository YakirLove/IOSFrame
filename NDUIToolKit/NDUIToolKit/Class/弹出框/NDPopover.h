...
typedef NS_ENUM(NSUInteger, NDPopoverPosition) {
    NDPopoverPositionUp = 1,
    NDPopoverPositionDown,
};

typedef NS_ENUM(NSUInteger, NDPopoverMaskType) {
    NDPopoverMaskTypeBlack,
    NDPopoverMaskTypeNone,  // overlay does not respond to touch
};

@interface NDPopover : UIView
 ...
 */
@property (nonatomic, assign, readonly) NDPopoverPosition popoverPosition;
...
/**
 *  The background of the popover, default is NDPopoverMaskTypeBlack;
 */
@property (nonatomic, assign) NDPopoverMaskType maskType;
