//
//  NDTDMessageTextView.m
//  NDTDChat
//
//  Created by 林 on 7/24/15.
//  Copyright (c) 2015 林. All rights reserved.
//

#import "NDTDTextView.h"

@implementation NDTDTextView
...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [NDTDTextView maxCharactersPerLine];
...
- (NSUInteger)numberOfLinesOfText {
    return [NDTDTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [NDTDTextView maxCharactersPerLine]) + 1;
}
