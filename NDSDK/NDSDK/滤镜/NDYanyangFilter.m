...
#import "NDYanyangFilter.h"

NSString *const kNDYanliShaderString = SHADER_STRING
(
...
@implementation NDYanyangFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kNDYanliShaderString]))
    {
		return nil;
    }
