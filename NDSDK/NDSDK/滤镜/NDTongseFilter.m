...
#import "NDTongseFilter.h"

NSString *const kNDTongseShaderString = SHADER_STRING
(
...
@implementation NDTongseFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kNDTongseShaderString]))
    {
		return nil;
    }
