...
#import "NDLengSeFilter.h"

NSString *const kNDLengSeShaderString = SHADER_STRING
(
...
@implementation NDLengSeFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kNDLengSeShaderString]))
    {
        return nil;
    }
